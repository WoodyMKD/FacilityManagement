...
using FacilityManagement.IdentityServer.Data;
using IdentityModel;
using IdentityServer4.Account;
...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<(EmployeeUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<EmployeeUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
